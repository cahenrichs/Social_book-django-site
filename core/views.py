...
def index(request):
    ...
    sug_username_profle_list = list(chain(*username_profile_list))


    return render(request, 'index.html', {'user_profile': user_profile, 'posts': feed_list, 'sug_username_profle_list' : sug_username_profle_list[:4]})
